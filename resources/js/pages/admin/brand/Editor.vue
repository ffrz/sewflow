...
const page = usePage();
const title = (!!page.props.data.id ? "Edit" : "Tambah") + " Brand";
const form = useForm({
...
const submit = () =>
  handleSubmit({ form, url: route('admin.brand.save') });
        ...
        <q-form class="row" @submit.prevent="submit" @validation-error="scrollToFirstErrorField">
          <q-card square flat bordered class="col">
            ...
            <q-card-section class="q-pt-none">
              ...
              <q-input autofocus v-model.trim="form.name" label="Nama Brand" lazy-rules :error="!!form.errors.name"
              ...
              <q-input v-model.trim="form.address" type="textarea" autogrow counter maxlength="255" label="Alamat"
            ...
            <q-card-section class="q-gutter-sm">
              ...
              <q-btn icon="cancel" label="Batal" :disable="form.processing"
                @click="router.get(route('admin.brand.index'))" />
            </q-card-section>
          </q-card>
        </q-form>
      </div>
